...
char showMe(char** myDictionary, char* tmp, const int words, const int letters);
char addWord(char** myDictionary, char* word, const int words, const int letters);
int main(int argv, char** argc){
  ...
  for(i=0;i<count; i++) {
    ...
    switch(choice){
      ...
      case '2':
        if(arExist == 1){
        showMe(myDictionary, tmp, words, letters);
         }
      ...
      case '3':
        if(arExist == 1){
          addWord(myDictionary, word, words, letters) ;
...
char addWord(char** myDictionary, char* word, const int words, const int letters){ 
          ...
          int k = 0;
          cin >> word;
          for (int i = 0; i < words && isalpha(word[k]); i++) {
